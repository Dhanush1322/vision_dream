...
function Technology() {
  return (
    <>
      ...
      <h3 className="heading-technology">Generation pf Amino acid inspired small molecules (AISM)
      </h3>
      ...
      <h3 className="heading-technology">Orally bioavailable amino acid inspired small molecules (AISM)</h3>
